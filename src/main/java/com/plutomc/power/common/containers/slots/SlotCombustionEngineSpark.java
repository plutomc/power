 ...
 */
public class SlotCombustionEngineSpark extends Slot
{
	public SlotCombustionEngineSpark(IInventory inventoryIn, int index, int xPosition, int yPosition)
	{
	...
	public static boolean isItemSpark(ItemStack stack)
	{
